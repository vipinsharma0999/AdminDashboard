    ...
    menuItems: [
      ...
      // },
      {
        icon: (
          ...
          >
            <path
              d="M12 2C9.24 2 7 4.24 7 7C7 9.76 9.24 12 12 12C14.76 12 17 9.76 17 7C17 4.24 14.76 2 12 2ZM12 10C10.62 10 9.5 8.88 9.5 7.5C9.5 6.12 10.62 5 12 5C13.38 5 14.5 6.12 14.5 7.5C14.5 8.88 13.38 10 12 10Z"
              fill="white"
            />

            <path
              d="M19.71 2.29C19.32 1.9 18.69 1.9 18.3 2.29L16.22 4.36L19.64 7.78L21.71 5.71C22.1 5.32 22.1 4.69 21.71 4.3L19.71 2.29ZM15.56 6.02L8 13.59V16H10.41L18 8.44L15.56 6.02Z"
              fill="white"
            />

            <path
              d="M4 18C4 16.9 4.9 16 6 16H18C19.1 16 20 16.9 20 18V20C20 21.1 19.1 22 18 22H6C4.9 22 4 21.1 4 20V18ZM6 18V20H18V18H6ZM12 14C12.83 14 13.5 13.33 13.5 12.5C13.5 11.67 12.83 11 12 11C11.17 11 10.5 11.67 10.5 12.5C10.5 13.33 11.17 14 12 14ZM18 13.7L15.55 11.25C15.15 10.85 14.52 10.85 14.12 11.25L10.62 14.75L8.88 13.01C8.48 12.61 7.85 12.61 7.45 13.01L6 14.46V16H18V13.7Z"
              fill="white"
            />
          </svg>
        ),
